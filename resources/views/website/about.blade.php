...
@section('_seo')
    <meta property="og:title" content="RonInve | About">
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="block-style-five d-flex mb-40 animated-hover-icon" data-aos="fade-up" data-aos-delay="20">
                        ...
                        <div class="text">
                            <h3 class="title">Team Collaborative</h3>
                            <p>Aenean sodales turpis dolor, vel convallis nulla porttitor vel. Nullam</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <section class="fancy-text-block blue-dark-gradient fancy-text-block-eight pt-90 pb-50">
        <div class="shape shape-one scene"><span data-depth=".1"><img src="{{ asset('website') }}/images/shape/map.png" alt=""></span></div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="text-wrapper text-wrapper-white mb-40" data-aos="fade-right" data-aos-delay="20">
                        <div class="section-title section-title-white mb-25">
                            <h2>Imagination becomes
                                reality here</h2>
                        </div>
                        <p>Integer sodales dictum mattis. Nunc ullamcorper efficitur massa, quis pellentesque arcu </p>
                ...
                <div class="col-lg-6">
                    <div class="img-holder text-lg-right mb-40" data-aos="fade-left" data-aos-delay="20">
                        <img src="{{ asset('website') }}/images/block/img-15.png" alt="Image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-item mb-40" data-aos="fade-up" data-aos-delay="30">
                        <div class="img-holder">
                            <img src="{{ asset('website') }}/images/team/img-1.jpg" alt="Team Image">
                            <div class="team-hover">
                                <div class="hover-content text-center">
                                    ...
                                    <p class="position">Senior Marketer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-item mb-40" data-aos="fade-up" data-aos-delay="40">
                        <div class="img-holder">
                            <img src="{{ asset('website') }}/images/team/img-2.jpg" alt="Team Image">
                            <div class="team-hover">
                                <div class="hover-content text-center">
                                    <ul class="social-link">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-item mb-40" data-aos="fade-up" data-aos-delay="50">
                        <div class="img-holder">
                            <img src="{{ asset('website') }}/images/team/img-3.jpg" alt="Team Image">
                            <div class="team-hover">
                                <div class="hover-content text-center">
                                    <ul class="social-link">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="team-item mb-40" data-aos="fade-up" data-aos-delay="60">
                        <div class="img-holder">
                            <img src="{{ asset('website') }}/images/team/img-4.jpg" alt="Team Image">
                            <div class="team-hover">
                                <div class="hover-content text-center">
                                    <ul class="social-link">
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="img-holder mb-50" data-aos="fade-right" data-aos-delay="20">
                        <img src="{{ asset('website') }}/images/faq/img-2.png" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="text-wrapper mb-50">
                                ...
                                <div class="card mb-10">
                                    <div class="card-header">
                                        <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">
                                            <i class="fas fa-question bg-two"></i> Wann kann ich mich testen lassen?
                                        </a>
                                    </div>
                                    <div id="collapseOne" class="collapse show"  data-parent="#accordionOne">
                                        <div class="card-body">
                                            <p>Morbi euismod sit amet sem non efficitur. Maecenas at blandit diam. Cras ut tortor id purus placerat euismod.
                                                Sed auctor metus</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-10">
                                    <div class="card-header">
                                        <a href="#" class="collapsed"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false">
                                            <i class="fas fa-question bg-two"></i>What questions do customers ask?
                                        </a>
                                    </div>
